...
- `tender-bloom-about.html` — About Me
- `tender-bloom-offerings.html` — Current Offerings
- `tender-bloom-contact.html` — Contact
- `tender-bloom-book.html` — Book a Session
...
1. Clone the repository:
    ```sh
    git clone https://github.com/yourusername/tenderbloom.git
    ```
2. Open the folder in your code editor.
3. Edit HTML, CSS, or JS as needed.
...
**Contact:**  
For questions or support, please email emjayh8@gmail.com
